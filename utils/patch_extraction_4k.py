...
from utils.hipt_heatmap_utils import *
from utils.patch_extraction import get_vit256, get_vit4k, tensorbatch2im, eval_transforms, roll_batch2img
...
class HIPT_4K(torch.nn.Module):
    ...
    def __init__(self,
                 model256_path: str = '../Checkpoints/model1_weights.pth',
    ...
    def get_region_attention_heatmaps(self, x, offset=128, scale=4, alpha=0.5,
                                      cmap=cmap_map(lambda x: x / 2 + 0.5, matplotlib.cm.jet), threshold=None):
        r"""
